...
import EarTankFighters.playerscuchi.TankMaster;
...
public class TableroTankFighters extends Container  {
	...
	void EjecutaTurno() throws Exception{
		...
		for( int i=0; i< this.P.length;i++){
			...
			//Colisiones con salirse de la pantalla
			if (this.posiciones[i]<0){this.posiciones[i]=0;}
			if (this.posiciones[i]>this.Ancho){this.posiciones[i]=this.Ancho;}
